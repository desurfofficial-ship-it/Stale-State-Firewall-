...
import { ActionExpiredError, ReplayDetectedError } from '../domain/errors.js';
...
export async function executeApprovedAction(
  ...
  return executeAction(ctx, intentInput, executor, { actionId });
}
...
function deadlineRace(deadlineAtMs: number, actionId: string, deadlineMs: number): Promise<never> {
